...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-A", type=str,
            help="data path for Domain A", required=True)
    
    parser.add_argument("--data-B", type=str,
            help="data path for Domain B", required=True)
    ...
    parser.add_argument("--cyc-weight", type=float,
            help="L1 lsos weight of cyc generator", default=10.0)
